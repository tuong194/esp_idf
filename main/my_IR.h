...
#define SHARP_MARK     280 //320
#define SHARP_SPACE_BIT_ONE 1800
#define SHARP_SPACE_BIT_ZERO 800

//AC
#define MITSUBISHI_HEADER_HIGH 3140
#define MITSUBISHI_HEADER_LOW 1630
#define MITSUBISHI_BIT_HIGH 370
#define MITSUBISHI_BIT_LOW_ZERO 420
#define MITSUBISHI_BIT_LOW_ONE 1220

#define PANASONIC_HEADER_HIGH 3500
#define PANASONIC_HEADER_LOW  1750
#define PANASONIC_BIT_HIGH 435
#define PANASONIC_BIT_LOW_ZERO 435
#define PANASONIC_BIT_LOW_ONE  1300

#define MIDEA_HEADER_HIGH   9400
#define MIDEA_HEADER_LOW    4700
#define MIDEA_BIT_HIGH  630
#define MIDEA_BIT_LOW_ZERO 560
#define MIDEA_BIT_LOW_ONE 1800
